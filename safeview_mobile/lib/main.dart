...
import 'screens/content_filter_screen.dart';
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      ...
      child: MaterialApp(
        ...
        routes: {
          '/': (_) => const _HomeShell(),
          '/filters': (_) => const ContentFilterScreen(),
          '/sensitivity': (_) => const SensitivityScreen(),
        },
        initialRoute: '/',
      ),
    );
    ...
    return Scaffold(
      ...
      bottomNavigationBar: NavigationBar(
        ...
        destinations: const [
          ...
          NavigationDestination(icon: Icon(Icons.sensors), label: 'Sensitivity'),
        ],
      ),
    );
  }
